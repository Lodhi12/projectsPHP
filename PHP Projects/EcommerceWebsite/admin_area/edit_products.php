<?php
    if (isset($_GET['edit_products'])){
        ...
        $result = mysqli_query($con,$get_date);
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_category" class="form-select">   
                    ...
                    <?php
                        ...
                        $row_category = mysqli_fetch_assoc($result_category_all);
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_brands" class="form-select">
                    ...
                    <?php
                        ...
                        $row_brand = mysqli_fetch_assoc($result_brand_all);
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php $product_image1?>" alt="" class="product_img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php $product_image2?>" alt="" class="product_img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php $product_image3?>" alt="" class="product_img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
<?php
    if (isset($_POST['edit_product'])){
        ...
        //checking for fields if they are empty or not
        if ($product_title == '' or $product_description == '' or $product_keywords == '' or
            ...
            $resut_update = mysqli_query($con,$update_product);
            if ($result_update){
